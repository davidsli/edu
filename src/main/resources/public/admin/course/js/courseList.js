					...
					.DataTable(
							{
								...
								"sAjaxSource" : "/admin/course/listData",
								"columns" : [
										{
											"data" : "courName",
											title : "课程名称"
											...
											render:function(data, type, row, meta){
													  html='<a style="cursor:pointer" class="table-link" onclick="editTaskModel(\''+data+'\')">'+
														'		<span class="fa-stack">'+
														'		<i class="fa1 fa-square fa-stack-2x"></i>'+
														'		<i class="fa1 fa-pencil fa-stack-1x fa-inverse"></i>'+
														'	</span>'+
														'</a>'+
														'<a style="cursor:pointer" class="table-link danger" onclick="deleteItemMember(\''+data+'\')">'+
														'	<span class="fa-stack">'+
														'		<i class="fa1 fa-square fa-stack-2x"></i>'+
